" Vim color file "
" set background to dark so we get correct defaults before we override
set background=dark

" clear the highlight
highlight clear

" check if we have syntax_on and reset if needed
if exists("syntax_on")
	syntax reset
endif

" lets call this theme "vimtana"
let g:colors_name = "vimtana"

" color definitions after this line
